...
###
noOfEndUsers=[5,7,6]
capacity=[10*(10**9),10*(10**9),10*(10**9)]
...
print(f"set of users who offloaded to secondary node:   {solveMultiKnapsack(remNodes,newCapacity,len(remUsersWeights),remUsersWeights)[0]}")
